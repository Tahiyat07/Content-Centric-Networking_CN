#
# OMNeT++/OMNEST Makefile for phoenix
#
...
OBJS = \
    $O/src/ContentDownloadApp.o \
    $O/src/ContentHostApp.o \
    $O/src/Demiurge.o \
    $O/src/Numen.o \
    $O/src/RFC8569Forwarder.o \
    $O/src/WiredTransport.o \
    $O/src/WirelessTransport.o \
    $O/src/InternalMessages_m.o \
    $O/src/RFC8609Messages_m.o \
    $O/src/TransportMessages_m.o

# Message files
MSGFILES = \
    src/InternalMessages.msg \
    src/RFC8609Messages.msg \
