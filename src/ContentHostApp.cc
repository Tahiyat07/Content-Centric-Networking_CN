       ...
       // get message arrival gate name
        ...
        if (strstr(gateName, "forwarderInOut$i") != NULL && interestMsg != NULL) {
            ...
            if (interestMsg->getSegmentNum() >= hostedContentEntry->totalNumSegments) {
                ...
                interestRtnMsg->setHeaderSize(PHOENIX_INTEREST_RTN_MSG_HEADER_SIZE);
                interestRtnMsg->setPayloadSize(0);
                interestRtnMsg->setByteLength(PHOENIX_INTEREST_RTN_MSG_HEADER_SIZE);
            ...
            // if right data segment requested, send data
                ...
                contentObjMsg->setHeaderSize(PHOENIX_INTEREST_RTN_MSG_HEADER_SIZE );
                ...
                contentObjMsg->setByteLength(PHOENIX_INTEREST_RTN_MSG_HEADER_SIZE  + segmentSize);
